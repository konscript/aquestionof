...
<table cellspacing="0" cellpadding="0" width="500" style="border:none; color:#444444">
	<tr>
		<td style="border-bottom: solid 1px #CCCCCC;">
			Order #<?php echo ECSE_purchase::get_the_purchase_ID() ?><br />
			<br />
			<br />
			...
			Your order is pending while we're processing the payment. We'll get back to you as soon as possible when it has been confirmed.<br /><br />
			<?php } else { ?>
			Your order has been processed - thanks for shopping with us! Your package is on it's way. If you have chosen GLS Package Shop for shipping, please see to pick it up. Otherwise sit back, relax and wait for you package to arrive.
			<?php } ?>
