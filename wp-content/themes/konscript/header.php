	...
	<div id="masterbar-container" class="custom-color-1">
		<div id="masterbar">
			...
			<div class="master-social">
				<a href="https://twitter.com/#!/a_question_of"><img src="<?php echo THEME_URI . '/resources/images/social/twitter.png'; ?>" alt="Twitter" /></a>
				<a href="http://consciousapparel.tumblr.com"><img src="<?php echo THEME_URI . '/resources/images/social/tumblr.png'; ?>" alt="Tumblr" /></a>								
				<a href="https://www.facebook.com/AQUESTIONOF"><img src="<?php echo THEME_URI . '/resources/images/social/facebook.png'; ?>" alt="Facebook" /></a>
			</div>				
