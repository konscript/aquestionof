 ...
 * WPSC Single Product
 *
 * Used for single product pages (equivalent to post.php)
 */
					...
					<div class="productcol entry-content">			
						...
						<form class="product_form" enctype="multipart/form-data" action="<?php echo wpsc_this_page_url(); ?>" method="post" name="1" id="product_<?php echo wpsc_the_product_id(); ?>">
							...
							<div class="wpsc_product_price">
								...
								<?php else : ?>
									...
									<?php endif; ?>
									<p class="pricedisplay <?php echo wpsc_the_product_id(); ?>"><?php //_e('Price:', 'wpsc'); ?><span id='product_price_<?php echo wpsc_the_product_id(); ?>' class="currentprice pricedisplay"><?php echo str_replace('from ', '', wpsc_the_product_price()); ?></span></p>
									<?php if(wpsc_product_on_special()) : ?>
						...
						<?php /** the variation group HTML and loop ends here */?>
							...
							<?php if(wpsc_has_multi_adding()): ?>
                            	<label for="wpsc_quantity_update_<?php echo wpsc_the_product_id(); ?>">Quantity</label>
