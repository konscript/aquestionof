...
<html>
	...
	<body style="font-family:verdana, sans-serif; font-size:12px; margin:0; width:100%; height:100%;">
		...
		<table width="100%" cellspacing="0" cellpadding="10" style="background-color: #eeeeee; color:#999999; height:100%">
			<tr>
				<td align="center" valign="middle">
					<h2><a href="<?php echo site_url() ?>" style="color:#999999; text-decoration:none"><?php bloginfo('name') ?></a></h2>
					<table width="600" cellspacing="0" cellpadding="50" style="background-color:white; border:solid 6px #CCCCCC; font-size:12px; color:#444444">
						<tr>
