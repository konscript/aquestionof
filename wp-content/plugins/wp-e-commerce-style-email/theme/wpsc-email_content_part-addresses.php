	...
	<tr>
		...
		<td align="left" valign="top">
			<?php if(ECSE_purchase::get_the_shipping_prop('shipping_method')) { ?>
				...
				<?php echo ECSE_purchase::get_the_shipping_prop('shippingcity', ', ') . ECSE_purchase::get_the_shipping_prop('shippingstate').' '.ECSE_purchase::get_the_shipping_prop('shippingpostcode').' '.ECSE_purchase::get_the_shipping_prop('shippingcountry') ?><br />
				<br />
				Shipping via:<br />
